...
!function(e){e(".nav-toggle").click(function(l){e(".nav ul").is(":visible")?(e(".nav ul").not(".nav ul ul").slideUp(400,function(){e(".nav ul").removeAttr("style")}),e(".header-mobile-social").slideToggle(400),e("a",this).removeClass("open")):(e(".nav ul").not(".nav ul ul").slideDown(400),e("a",this).addClass("open"),e(".header-mobile-social").slideToggle(400)),l.preventDefault()}),e(".nav ul li").each(function(){e(this).has("ul").length&&(e(this).append("<span>+</span>"),e("span",this).click(function(){e(".nav ul ul").is(":visible")&&e(".nav ul li.open").removeClass("open").find("span").text("+").parent().find("ul").slideUp(300),e(this).parent().find("ul").is(":visible")?(e(this).text("+").parent().find("ul").slideUp(300),e(this).parent().removeClass("open")):(e(this).text("−").parent().find("ul").slideDown(300),e(this).parent().addClass("open"))}))}),e(".aside-toggle").click(function(l){e(".aside-drawer").is(":visible")?(e(".aside-drawer").slideUp(400),e("a",this).text("Open Filters")):(e(".aside-drawer").slideDown(400),e("a",this).text("Close Filters")),l.preventDefault()}),e(".scrollable").click(function(l){l.preventDefault();var i=e(this).attr("href");e("html,body").animate({scrollTop:e(i).offset().top},"slow"),l.preventDefault()})}(jQuery);