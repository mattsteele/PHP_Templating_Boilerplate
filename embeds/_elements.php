...
/* Called in elements.php to fill within page structure
   Updated: 2013-06-11
--------------------------------------------------------------------*/
?>

	<!--
	<h1>Title 01 Heading with a really really really really really really really long name</h1>
	<h2>Title 02 Heading with a really really really really really really really really really really really really really really really long name</h2>
	<h3>Title 03 Heading with a really really really really really really really really really really really really really really really really really really really really long name</h3>
	<h4>Title 04 Heading with a really really really really really really really really really really really really really really really really really really really really long name</h4>
	<h5>Title 05 Heading with a really really really really really really really really really really really really really really really really really really really really really really long name</h5>
	<h6>Title 06 Heading with a really really really really really really really really really really really really really really really really really really really really really really long name</h6>
	-->
    ...
    <form action="#">
      <fieldset>
        <legend>Form legend: (standard form)</legend>
        ...
        <p>
        	<label for="rt1">Required Text input:</label>
        	<input type="text" id="rt1" required />
        </p>
        <p>
        	<label for="twp1">Text input with pattern requirement and placeholder:</label>
        	<input type="text" pattern="\d{5}(-\d{4})?" title="a US Zip code, with or without the +4 exension" placeholder="12345-6789"/>
        </p>
        <p>
        	<label for="s1">Search input:</label>
        	<input type="search" id="s1" />
        </p>
        <p>
        	<label for="e1">Email input:</label>
        	<input type="email" id="e1" />
        </p>
        <p>
        	<label for="u1">URL input:</label>
        	<input type="url" id="u1" />
        </p>
        <p>
        ...
        <p>
        	<label for="f2">
        		<input type="radio" id="f2" />Radio input
        	</label>
        </p>
        <p>
        	<label for="f3">
        		<input type="checkbox" id="f3" />Checkbox input
        	</label>
        </p>
        <p>
        ...
        <p>
        	<label for="f7">Submit Button:</label>
        	<input type="submit" id="f7" value="button text" />
        </p>
    ...
    <form class="two_col_form group validate" action="#">
      <fieldset class="first">
        <legend>Form legend: (two column form, validated w/ jQ)</legend>

        <p>
        	<label for="f1">Optional Text input: <span class="error_placehold">required</span></label>
        	<input type="text" id="f1" value="" class="required" />
        </p>
        <p>
        	<label for="f4">Select field:</label>
        	<span class="styled_select">
	        	<select id="f4" class="required">
