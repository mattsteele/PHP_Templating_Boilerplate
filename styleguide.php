...
<div class="content-wrapper mobile-wrapper">
	...
	<h2 class="color-chip-spacing">$blue-2 #708ead<span class="color-chip blue-2-background"></span></h2>
...
<div class="content-wrapper mobile-wrapper">
	...
	<p>This paragraph uses the {{ FONT NAME }} font. You can add the {{ FONT NAME }} font by adding the class ".{{ FONT NAME }}" to any HTML element.</p>

	<p>This paragraph uses the {{ FONT NAME }} font. You can add the {{ FONT NAME }} by adding the class ".{{ FONT NAME }}" to any HTML element.</p>
	<hr />
	<h2>Links</h2>
